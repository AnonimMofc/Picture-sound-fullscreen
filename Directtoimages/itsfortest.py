...
def play_sound():
    playsound('') # Название звуквой дорожки + формат(smth.mp3/smth.wav)   |||  Name of sound + format(smth.mp3/smth.wav)

img = cv2.imread('') # Название картинки + формат(smth.jpg и т.д.)   ||| Name of pic + format(smth.jpg etc.)
